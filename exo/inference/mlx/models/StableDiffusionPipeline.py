...
class Model(nn.Module):
    ...
    def __call__(self,x, step= 0, cfg_weight: float = 7.5,total_steps=5,conditioning=None,mask=None,residual=None,x_t_prev=None,is_finished=False,is_step_finished=False):
